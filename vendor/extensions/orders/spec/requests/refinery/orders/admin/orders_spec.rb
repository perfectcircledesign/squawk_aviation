      ...
      describe "orders" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:order, :order_number => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:order, :order_number => "A order_number") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:order, :order_number => "UniqueTitleOne") }
