...
module Refinery
  class Page < Refinery::Core::BaseModel
    ...
    attr_accessible :id, :deletable, :link_url, :menu_match, :meta_keywords,
                    ...
                    :page_id, :layout_template, :view_template, :custom_slug, :footer
    ...
    class << self
      ...
      def fast_menu(columns = [])
        ...
        pages = live.is_not_footer.in_menu.order('lft ASC').includes(:translations)
  ...
  private
    ...
    scope :is_footer, where(:footer => true)
    scope :is_parent, where(:depth => 0)
